...
def uniformCostSearch(problem):
    	UCPacman = util.PriorityQueue()
	UCPacman.push((problem.getStartState(),[]),0)
	explored = []
	while not UCPacman.isEmpty():
		node,actions = UCPacman.pop()
		...
		for coord,direction,steps in problem.getSuccessors(node):
			...
			UCPacman.push((coord,new_actions),problem.getCostOfActions(new_actions))
   	return []
